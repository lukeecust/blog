document.addEventListener('DOMContentLoaded', function() {
  ...
  switcherBtn.style.cssText = 'background: transparent; border: 1px solid var(--link-color, #2a408e); color: var(--link-color, #2a408e); padding: 0.25rem 0.5rem; border-radius: 0.25rem; font-size: 0.9rem; cursor: pointer;';
  ...
  // 设置鼠标悬停效果
  switcherBtn.addEventListener('mouseover', function() {
    this.style.backgroundColor = 'var(--link-color, #2a408e)';
    this.style.color = 'white';
  });
  
  switcherBtn.addEventListener('mouseout', function() {
    this.style.backgroundColor = 'transparent';
    this.style.color = 'var(--link-color, #2a408e)';
  });
