...
title: Journal Links
author: lukeecust
date: 2025-12-23 00:09:00 +0800
categories: [Publication Notes]
lang: zh
math: true
translation_id: journals-links
permalink: /zh/posts/journals-links/
render_with_liquid: false
---

## AAAS
- Science Advances (Sci Adv): [www.science.org/journal/sciadv](https://www.science.org/journal/sciadv)

## ACS
- ACS ES&T Engineering (ACS ES&T Eng): [pubs.acs.org/journal/aeecco](https://pubs.acs.org/journal/aeecco)
- Environmental Science & Technology (ES&T): [pubs.acs.org/journal/esthag](https://pubs.acs.org/journal/esthag)
- Industrial & Engineering Chemistry Research (I&ECR): [pubs.acs.org/journal/iecred](https://pubs.acs.org/journal/iecred)
...
- Green Energy & Environment (GEE): [www.sciencedirect.com/journal/green-energy-and-environment](https://www.sciencedirect.com/journal/green-energy-and-environment)
- Process Safety and Environmental Protection (PSEP): [www.sciencedirect.com/journal/process-safety-and-environmental-protection](https://www.sciencedirect.com/journal/process-safety-and-environmental-protection)
...
- International Conference on Learning Representations (ICLR)
  - Conference site: [iclr.cc](https://iclr.cc/)
  - Papers/program (2025): [iclr.cc/virtual/2025/papers.html](https://iclr.cc/virtual/2025/papers.html)
  - OpenReview venue page: [openreview.net/group?id=ICLR.cc](https://openreview.net/group?id=ICLR.cc)

- International Conference on Machine Learning (ICML)
  - Conference site: [icml.cc](https://icml.cc/)
  - OpenReview venue page: [openreview.net/group?id=ICML.cc](https://openreview.net/group?id=ICML.cc)

- Neural Information Processing Systems (NeurIPS)
  - Conference site: [neurips.cc](https://neurips.cc/)
  - Papers/program (2025): [neurips.cc/virtual/2025/papers.html](https://neurips.cc/virtual/2025/papers.html)
  - OpenReview venue page: [openreview.net/group?id=NeurIPS.cc](https://openreview.net/group?id=NeurIPS.cc)

- Transactions on Machine Learning Research (TMLR)
  - Journal site: [jmlr.org/tmlr](https://jmlr.org/tmlr/)
  - OpenReview venue page: [openreview.net/group?id=TMLR](https://openreview.net/group?id=TMLR)
  - OpenReview submissions browser: [openreview.net/submissions?venue=TMLR](https://openreview.net/submissions?venue=TMLR)
...
- Nature Chemical Engineering (Nat Chem Eng): [www.nature.com/natchemeng](https://www.nature.com/natchemeng/)
- Nature Communications (Nat Commun): [www.nature.com/ncomms](https://www.nature.com/ncomms/)
- Nature Machine Intelligence (Nat Mach Intell): [www.nature.com/natmachintell](https://www.nature.com/natmachintell/)

## Taylor & Francis
- International Journal of Control (IJC): [www.tandfonline.com/journals/tcon20](https://www.tandfonline.com/journals/tcon20)

## Wiley
- AIChE Journal (AIChE J): [aiche.onlinelibrary.wiley.com/journal/15475905](https://aiche.onlinelibrary.wiley.com/journal/15475905)
- The Canadian Journal of Chemical Engineering (CJCE): [onlinelibrary.wiley.com/journal/1939019x](https://onlinelibrary.wiley.com/journal/1939019x)
