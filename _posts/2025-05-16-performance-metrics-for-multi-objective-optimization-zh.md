...
- **<font color="blue">计算每个解与真实帕累托前沿之间的最小欧氏距离</font>**：对于$PF_{\text {approx}}$中的每个解，计算它与 $PF_{\text {true }}$上所有解$z_j$的欧氏距离，并取最小值$d_i=\min _{z_j \in P F_{\text {true }}}$ distance $\left(x_i, z_j\right)$。
